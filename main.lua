...
-- functions 
    ...
    -- library functions 
        function library:window(properties) 
            local cfg = {
                name = properties.Name or properties.name or properties.Title or properties.title or "drain.lol", 
                size = properties.Size or properties.size or dim2(0, 500, 0, 650)
            }
            
            local animated_text = library:animation( cfg.name .. " | build: private ") 
        ...
        function library:notification(properties)
            local cfg = {
                ...
                text = properties.text or properties.name or "drain.lol is pasted"
            }
